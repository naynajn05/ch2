...
public class LambdaCollection {
	...
	//	Collections.sort(studentList); //CTE
		...
		Comparator<Student> comp1 = (st1, st2) -> (int)(st1.getPer() - st2.getPer());//lambda Expression
		//int compare(T o1,To2);
		//Comparator<Student> comp =(s3,s4)->(int)(s3.getRollNo()-s4.getRollNo());
		...
		System.out.println("Student details in Descending order of Per : "+studentList);
		  ...
		  Collections.sort(studentList,comp1);
		  System.out.println("Student details in ascending order of Student Name : "
		  +studentList);
