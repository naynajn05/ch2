...
public class ListDemo {
	...
	public static void main(String[] args) {
		/*
		 * // Adding User Defined objects into ArrayList //List studentList = new
		 * ArrayList(); // Point p1=new Point(12,4.5f); Point p2=new Point(10,20);
		 * List<Point> pList=new ArrayList<Point>(); pList.add(p1); pList.add(p2);
